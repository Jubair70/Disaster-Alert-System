        ...
        if ($('.alert-block').is(':visible')) {
            ...
            $('#generate_report').on('click', function (e) {
               ...
               table.destroy();
                ...
                $.ajax({
                    url: '/modules/get_flood_archive_list/',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        'from_date':from_date
