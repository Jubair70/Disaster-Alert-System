        ...
        if ($('.alert-block').is(':visible')) {
            ...
            $('#generate_report').on('click', function (e) {
               ...
               table.destroy();
                ...
                $.ajax({
                    url: '/modules/get_cyclone_index_files_list/',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        'from_date':from_date
...
//                            <a class="tooltips"  style="margin-left:10px" data-placement="top" data-container="body" title="Detail" href="/modules/detail-cyclone-index/' + list[idx].id +'"><i class="fas fa-map"></i></a>
                        for (var idx in list) {
                            tbody += '<tr><td>' + list[idx].file_source + '</td><td>' + list[idx].file_name +'</td><td>' + list[idx].added_on +'</td><td>' + list[idx].added_by +'</td><td>' + list[idx].published_year +'</td><td class="td-center"><a class="delete-item tooltips"  style="margin-left:10px" data-placement="top" data-toggle="modal"   title="Detail" href="/modules/detail-cyclone-index/' + list[idx].id +'"><i class="fas fa-map-marked"></i></a><a class="tooltips" style="margin-left:10px" data-container="body"  data-placement="top" href="'+list[idx].file_loc+'" title="Download" download><i class="fas fa-download"></i></i></a><a class="delete-item tooltips"  style="margin-left:10px" data-placement="top" data-toggle="modal"  data-target="#confirm-delete" title="Delete" href="#" data-href="/modules/delete_cyclone_index_files/' + list[idx].id +'"><i class="fa fa-trash-alt"></i></a></td></tr>';
                        }
