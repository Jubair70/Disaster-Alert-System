...
from usermodule.models import MenuItem,UserModuleProfile
...
def additional_menu_items(request):
    ...
    # print("Sub menu ",sub_menu_items)
    try:
        user_id = request.user.id
        qry = "select user_img from usermodule_usermoduleprofile where user_id ="+str(user_id)
        df = pandas.DataFrame()
