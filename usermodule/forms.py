...
class UserForm(forms.ModelForm):
    password = forms.CharField(label='Create a password',widget=forms.PasswordInput(),min_length=6)
    password_repeat = forms.CharField(label='Confirm your password',widget=forms.PasswordInput())
    # email = forms.EmailField(required=True)
    username = forms.CharField(help_text='',max_length=200)
    ...
    class Meta:
        ...
        fields = ('username', 'first_name', 'last_name', 'password') # ,'is_superuser' 'date_joined',
...
class UserEditForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('username','first_name', 'last_name') # ,'is_superuser','date_joined'
...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = (
        'admin', 'organisation_name', 'contact_number')
...
class ChangePasswordForm(forms.Form):
    ...
    old_password = forms.CharField(label="Old",required=True,widget=forms.PasswordInput(),min_length=6)
    new_password = forms.CharField(label="New",required=True,widget=forms.PasswordInput(),min_length=6)
